...
struct CharacterData
{
    ...
    // ドット画像のファイル名
    string getDotFileName() const { return ResourcesManager::getInstance()->getCurrentPath() + "/" + CsvDataManager::getInstance()->getCharacterData()->getFileName(this->chara_id) + "_0_0.png"; };
    
    // 立ち絵画像のファイル名
    string getStandFileName() const { return ResourcesManager::getInstance()->getCurrentPath() + "/" + CsvDataManager::getInstance()->getCharacterData()->getFileName(this->chara_id) + "_s_1.png"; }
